A responsive website that allows you to trade party tickets and invite new friends to enjoy a variety of individual actions and trade tickets with profit commissions per user. The project was built using **React, Node.js, and Docker** for containerization and easier deployment.
